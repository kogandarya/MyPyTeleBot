...
m_games = Menu("Игры", buttons=["Камень, ножницы, бумага", "КНБ Multiplayer", "Игра в 21", "Угадай кто?", "Выход"], parent=m_main)
...
m_fun = Menu("Развлечения", buttons=["Прислать собаку", "Прислать лису", "Прислать анекдот", "Прислать факт", "Прислать новости", "Прислать фильм", "Выход"], parent=m_main)
